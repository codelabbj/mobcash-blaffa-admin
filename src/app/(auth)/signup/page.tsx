...
const formSchema = z.object({
    ...
    password: z.string({message: "Veuillez entrer votre mot de passe"}).min(4, {message: "Le mot de passe doit contenir au moins quatre (04) caractères"}),
    confirmPassword: z.string({message: "Veuillez confirmer votre mot de passe"})
            ...
            <div className="lg:col-span-3 flex flex-col items-center justify-center space-y-8 px-8">
                ...
                <div className="w-full max-w-md space-y-6">
                    <div className="space-y-2">
                        <p className="text-4xl font-bold text-foreground">Créer un compte</p>
                        <p className="text-muted-foreground text-sm">
                            Inscrivez-vous pour commencer à gérer vos opérations mobile money
                        </p>
                    </div>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="font-semibold text-foreground">Confirmer le mot de passe</FormLabel>
                                        <FormControl>
                                            <div className="relative">
                                                <Input
