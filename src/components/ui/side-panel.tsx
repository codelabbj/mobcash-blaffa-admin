            ...
            <>
                ...
                <div
                    className={cn(
                        ...
                        "z-50 flex flex-col transition-all duration-300 w-full sm:w-96",
                ...
                >
                    ...
                    {footer && <div className="border-t border-border p-4 sm:p-6 flex-shrink-0">{footer}</div>}
                </div>
            </>
        )
    }

    // Desktop: use embedded mode
    if (embedded) {
        return (
            <div
                className={cn(
